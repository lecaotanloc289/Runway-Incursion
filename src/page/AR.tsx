...
const AirportRunway2: React.FC<RunwayProps> = ({ width = 800, height = 400 }) => {
  return (
    <div className='w-full max-w-4xl mx-auto p-4'>
      <svg viewBox={`0 0 ${width} ${height}`} className='w-full h-auto border border-gray-300 rounded-lg shadow-lg'>
        {/* Main Runway */}
        <rect
          x={100}
          y={150}
